public class Ejercicios {
    public static void main(String[] args) {
        ...
        System.out.println("\nEJERCICIO 5\n");
        /*
         * Se tiene tres arreglos unidimensionales que guardan los precios unitarios
         * (PU) las
        ...
        String[] descripciones = {
                "Producto 1038iwjsm3", "Producto 10i9edxjd", "Producto 2i0jqwjtgf", "Producto s3ihnx3nr9",
                "Producto 2eioc3hnrun"
        };
        ...
        System.out
                .println("Producto con mayor gasto: " + mayorTotalDescripcion + " con total gastado de: " + mayorTotal);

        System.out.println("\nEJERCICIO 6\n");
        /*
         * Una agencia administradora de inmuebles ha decidido guardar en un arreglo
         * lineal de
        ...
        // Contar los pares e impares y reservar en memoria los arreglos con esas
        // cantidades
        int cantidadPares = 0;
        ...
        System.out.println("\nEJERCICIO 10\n");
        /*
         * Dado un arreglo A de N elementos se desea crear otro arreglo, tal que cada
         * uno de sus
        ...
        // Consultar la cantidad de pares, impares y ceros para reservar la memoria de
        // los arreglos
        ...
        for (int i = 0; i < arregloA.length; i++) {
            if (arregloA[i] == x) {
                iguales[posicionSiguiente] = i + 1; // Aumentar en 1, ya que la posición se desea guardar comenzando
                                                    // desde el 1
                posicionSiguiente++;
            }
        }
        ...
        System.out.println("\nEJERCICIO 14\n");
        /*
         * Dado un arreglo de N elementos se desea obtener otro arreglo tal que sus
         * elementos
        ...
        System.out.println("\nEJERCICIO 15\n");
        /*
         * Se tienen los nombres y los sueldos de los trabajadores de una empresa. Se
         * desea
